-- Extend brief trigger to notify admins too
...
-- Extend convert_paid_order_service_purchases to notify admins/team leaders when a new fixed-agreement purchase is created
